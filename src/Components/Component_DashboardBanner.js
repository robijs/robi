        ...
        data.forEach(item => {
            ...
            html += /*html*/ `
                <div class='dashboard-banner-group' style='background: ${background || 'transparent'}' data-label='${label}' data-action='${action ? 'true' : 'false'}'>
                    <div class='dashboard-banner-label' style='color: ${color || Setting_App.defaultColor}'>${label}</div>
                    <div class='dashboard-banner-value' style='color: ${color || Setting_App.defaultColor}'>${value}</div>
                    <div class='dashboard-banner-description' style='color: ${color || Setting_App.defaultColor}'>${description || ''}</div>
                </div>
            `;
        });
