...
export default function Component_Feedback(param) {
    ...
    const component = Component({
        ...
        style: /*css*/ `
            ...
            #id .new-comment:focus{
                outline: none;
                border-left: solid 1px ${Setting_App.primaryColor};
                border-top: solid 1px ${Setting_App.primaryColor};
                border-bottom: solid 1px ${Setting_App.primaryColor};
            }
            ...
            #id .new-comment:focus ~ .new-comment-button-container {
                border-radius: 0px 4px 4px 0px;
                border-right: solid 1px ${Setting_App.primaryColor};
                border-top: solid 1px ${Setting_App.primaryColor};
                border-bottom: solid 1px ${Setting_App.primaryColor};
            }
            ...
            #id .comment {
                ...
                padding: 7.5px 15px;
                border-radius: 4px;
                background: rgba(${Setting_App.primaryColorRGB}, .1);
            ...
            #id .comment-container.mine .comment {
                background: rgba(${Setting_App.primaryColorRGB}, .8);
        ...
        events: [
            ...
            },
            {
                ...
                async listener(event) {
                    ...
                    const SubmittedBy = Action_Store.user().Title
                    const LoginName = Action_Store.user().LoginName;
    ...
    function commentTemplate(comment, isNew) {
        return /*html*/ `
            <div class='comment-container${comment.LoginName ===Action_Store.user().LoginName ? ' mine' : ''}${isNew ? ' animate-new-comment' : ''}' data-itemid='${comment.Id}'>
                <div class='comment'>
                    <div class='comment-date-container'>
                        ${comment.LoginName !== Action_Store.user().LoginName ? /*html*/`<div class='comment-author'>${comment.SubmittedBy}</div>` : ''}
