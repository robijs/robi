...
export default function Component_QPPCard(param) {
    const {
        title,
        subTitle,
        marketId,
    ...
    const component = Action_Component({
        html: /*html*/ `
            <div class='card'>
                <div class='card-body'>
                    ...
                    <span class='btn btn-primary all-plans' data-marketid='${marketId}'>Go to all plans</span>
                </div>
        ...
        events: [
            {
                selector: '#id .all-plans',
                event: 'click',
                listener(event) {
                    Action_Route(`Markets/${marketId}`);
                }
            },
            {
