...
import { Store, Style, App, CreateItem, UploadFile, GetSession } from '../../Robi/Robi.js'
    ...
    function showForm() {
        ...
        const modal = Modal({
            ...
            async addContent(modalBody) {
                ...
                // NOTE: Recordings (.webm) might not upload to CarePoint or LaunchPad due to WAF issues.
                modalBody.insertAdjacentHTML('beforeend', /*html*/ `
