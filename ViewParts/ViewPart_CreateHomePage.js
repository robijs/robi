...
export default async function ViewPart_CreateHomePage(param) {
    const {
        fiscalYear,
        parent,
        modal
    ...
    const lifecycleImgDropdown = Component_BootstrapDropdown({
        ...
        label: /*html*/ `
            ...
            <div style='margin: 10px 0px;'>
                <img src='/sites/J5/QPP/App/src/Images/image.png' style='height: 100px; border-radius: 4px;'>
            </div>
        `,
